...
def main():
    ...
    t9Woord = input("voer een woord in waar u de t9 cijfercombinatie van wilt: ")
    gsmoniemInvoer1 = input("geef een woord waarvan u wilt testen of het een gsmoniem is (woord 1 van de 2): ")
    gsmoniemInvoer2 = input("geef een woord waarvan u wilt testen of het een gsmoniem is (woord 2 van de 2): ")
    # een stukje code om de uitvoer van de gsmoniemen functie goed weer te geven
    gsmoniemUitvoer = ""
    if not(gsmoniemen(gsmoniemInvoer1,gsmoniemInvoer2)):
        gsmoniemUitvoer = "geen "
    # print de 2 uitvoer regels
    print("\nde T9 cijfercombinatie van het woord %s is: %s" % (t9Woord, t9(t9Woord)))
    print("de woorden %s en %s zijn %sGSMoniemen" % (gsmoniemInvoer1, gsmoniemInvoer2, gsmoniemUitvoer))
